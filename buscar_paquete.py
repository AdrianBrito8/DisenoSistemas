...
def main():
    ...
    # *** CORRECCIÓN PARA EL NUEVO PROYECTO ***
    # Cambiamos "python_forestacion" por "python_cloud_infra"
    nombre_paquete_default = "python_cloud_infra" 
    
    print(f"[INFO] Buscando desde: {directorio_raiz}")
    print(f"[INFO] Buscando paquete: {nombre_paquete_default}")
    print("")

    # Buscar el paquete
    paquetes = buscar_paquete(directorio_raiz, nombre_paquete_default)
    ...
    if paquetes:
        ...
        print(f"[!] No se encontro el paquete {nombre_paquete_default}")
        return 1
